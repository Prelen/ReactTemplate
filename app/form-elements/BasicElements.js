      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col-12 grid-margin">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Accept/Reject Offer</h4>
                <form className="form-sample">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <label className="col-sm-3 col-form-label">Audience</label>
                        <div className="col-sm-9">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <button class="btn btn-danger btn-rounded btn-fw">Reject</button>&nbsp;
                      <button class="btn btn-success btn-rounded btn-fw">Accept</button>
                    </div>
                    <div className="col-md-6">
                      <Form.Group className="row">
                        <label className="col-sm-3 col-form-label">Description</label>
