...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      {path:'/product-owner', state: 'productOwnerMenuOpen'}
    ];
    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a className="sidebar-brand brand-logo" href="index.html">Connectorfizer</a>
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/product-owner') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.productOwnerMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('productOwnerMenuOpen') } data-toggle="collapse">
            ...
            <Collapse in={ this.state.productOwnerMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={ this.isPathActive('/product-owner/AddProduct') ? 'nav-link active' : 'nav-link' } to="/product-owner/add-product"><Trans>Add Products</Trans></Link></li>
